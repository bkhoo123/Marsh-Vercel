...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div>{selection[activeSelection]}</div>

      {/* <button className="absolute bottom-16 left-16 p-3 rounded-md drop-shadow-dark bg-[#4E9AD0] text-white hover:bg-stone-400" >
        Tutorial
      </button> */}

      <a
        className="absolute bottom-20 right-20 mb-5 bg-orange-600 p-3 rounded-md drop-shadow-dark text-white hover:bg-stone-400"
      ...
      <button
        onClick={() => router.push("/")}
        className="absolute bottom-10 right-10 bg-orange-600 p-3 rounded-md drop-shadow-dark text-white hover:bg-stone-400"
      >
