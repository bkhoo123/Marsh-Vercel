...
export default function HomeNav({ active }) {
  ...
  return (
    <div
      ...
      className="w-[100%] h-[200px] flex flex-row justify-between items-center px-10 pt-4"
    >
      <div className="flex flex-row items-center gap-16">
        <div
          onClick={() => {
            active("How to Play");
            setCurrent("How to Play");
          }}
          className="flex flex-col gap-2 cursor-pointer  hover:scale-105 "
        >
          <Image
            src={HowtoPlay}
          ...
          <div
            className={
              current === "How to Play"
                ? "text-amber-500 drop-shadow-dark text-center"
                : "text-white drop-shadow-dark text-center"
            }
          >
            How to Play
          </div>
      ...
      <div className="flex flex-row items-center gap-16">
        <div
          ...
          className="flex flex-col gap-4 cursor-pointer hover:scale-105"
        >
          <Image src={Friends} className="h-[120px] w-[160px]" alt="Friends" />
          <div
            className={
              current === "Friends"
                ? "text-amber-500 drop-shadow-dark text-center"
